...
(function (modules) {
	...
	[
		...
		function (module, exports, __webpack_require__) {
			...
			var opacityUpdate = function opacityUpdate(opacity) {
				...
				try {
					for (
						var _iterator = this.textEntities[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true
					) {
		...
		function (module, exports, __webpack_require__) {
			...
			AFRAME.registerComponent("keyboard", {
				...
				init: function init() {
					...
					this.el.setAttribute("position", "-3 -4 -4");
	...
	*/
			Utils.preloadAssets = function (assets_arr) {
				...
				try {
					for (
						var _iterator = assets_arr[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true
					) {
						...
						try {
							for (
								var _iterator2 = assets.children[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next())
			...
			Behaviors.showKeyboard = function (el) {
				...
				try {
					for (
						...
						try {
							for (
								var _iterator2 = item.children[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next())
									.done); _iteratorNormalCompletion2 = true
							) {
			...
			Behaviors.openKeyboard = function (el) {
				...
				try {
					var _loop = function _loop() {
						...
						try {
							for (
								var _iterator4 = item.children[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next())
					...
					for (
						var _iterator3 = el
							.querySelectorAll("[data-ui]")[Symbol.iterator](),
							_step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true
					) {
						_loop();
					}
			...
			Behaviors.dismissKeyboard = function (el) {
				...
				try {
					var _loop2 = function _loop2() {
						...
						try {
							for (
								var _iterator6 = item.children[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next())
				...
				try {
					for (
						var _iterator7 = document
							.querySelectorAll("[key-id]")[Symbol.iterator](),
				...
				onClick: function onClick(noemit) {
					if (this.data.name) {
						...
						if (nearestForm) {
							...
							try {
								for (
									var _iterator = children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next())
